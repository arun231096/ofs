...
CREATE TABLE employee	(
	 ...
	 `desg_id`    INT,
	              ...
	              KEY k_employee_college_department (`dept_id`),
	              KEY k_employee_designation (`desg_id`),
	              CONSTRAINT fk_employee_college 
	              FOREIGN KEY (`college_id`) REFERENCES college(`id`)  ON DELETE NO ACTION ON UPDATE NO ACTION,    
	              CONSTRAINT fk_employee_college_department
	              FOREIGN KEY (`dept_id`) REFERENCES college_department(`cdept_id`)  ON DELETE NO ACTION ON UPDATE NO ACTION,
	              CONSTRAINT fk_employee_designation
					  FOREIGN KEY (`desg_id`) REFERENCES designation(`id`)  ON DELETE NO ACTION ON UPDATE NO ACTION
);
